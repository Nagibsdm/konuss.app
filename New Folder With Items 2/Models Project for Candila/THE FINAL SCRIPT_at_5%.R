...
setwd("~/Desktop/Models Project for Candila")
...
bonds_M5_vol<-bonds_fit_dagm_norm$est_vol_in_s
...
bonds_M6_vol<-bonds_fit_dagm_s_norm$est_vol_in_s
...
# sGARCH-norm VaR (5%),sGARCH-norm ES (5%)
...
plot(1:N,coredata(r_t_est),type="l",
     ...
     xlab="",ylab="SSMI: Returns, VaR and ES (5%)",
...
legend(
  "topright",
  c("SSMI daily ret.","sGARCH-norm VaR (5%)","sGARCH-norm ES (5%)"),
  lty=1,
...
# gjrGARCH-norm VaR (5%),gjrGARCH-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","gjrGARCH-norm VaR (5%)","gjrGARCH-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# eGARCH-norm VaR (5%),eGARCH-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","eGARCH-norm VaR (5%)","eGARCH-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# csGARCH-norm VaR (5%),csGARCH-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","csGARCH-norm VaR (5%)","csGARCH-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# sGARCH-std VaR (5%),sGARCH-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","sGARCH-std VaR (5%)", "sGARCH-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# gjrGARCH-std VaR (5%),gjrGARCH-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","gjrGARCH-std VaR (5%)","gjrGARCH-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# eGARCH-std VaR (5%),eGARCH-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","eGARCH-std VaR (5%)","eGARCH-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# csGARCH-std VaR (5%),csGARCH-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","csGARCH-std VaR (5%)","csGARCH-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# Unemployment GARCH-MIDAS-norm VaR (5%),Unemployment GARCH-MIDAS-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","unemployment_GARCH-MIDAS-norm VaR (5%)","unemployment_GARCH-MIDAS-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# GARCH-MIDAS-skew norm VaR (5%),GARCH-MIDAS-skew norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","unemployment_GARCH-MIDAS-skew norm VaR (5%)","unemployment_GARCH-MIDAS-skew norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# unemployment_GARCH-MIDAS-std VaR (5%),unemployment_GARCH-MIDAS-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","unemployment_GARCH-MIDAS-std VaR (5%)","unemployment_GARCH-MIDAS-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# unemployment_GARCH-MIDAS-skew std VaR (5%), unemployment_GARCH-MIDAS-skew std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","unemployment_GARCH-MIDAS-skew std VaR (5%)","unemployment_GARCH-MIDAS-skew std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# unemployment_DAGM-norm VaR (5%),unemployment_DAGM-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","unemployment_DAGM-norm VaR (5%)","unemployment_DAGM-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# DAGM-skew norm VaR (5%),DAGM-skew norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","unemployment_DAGM-skew norm VaR (5%)","unemployment_DAGM-skew norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# real_gdp GARCH-MIDAS-norm VaR (5%),real_gdp GARCH-MIDAS-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_GARCH-MIDAS-norm VaR (5%)","real_gdp_GARCH-MIDAS-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_GARCH-MIDAS-skew norm VaR (5%)","real_gdp_GARCH-MIDAS-skew norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# real_gdp_GARCH-MIDAS-std VaR (5%),real_gdp_GARCH-MIDAS-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_GARCH-MIDAS-std VaR (5%)","real_gdp_GARCH-MIDAS-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# real_gdp_GARCH-MIDAS-skew std VaR (5%), real_gdp_GARCH-MIDAS-skew std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_GARCH-MIDAS-skew std VaR (5%)","real_gdp_GARCH-MIDAS-skew std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# real_gdp_DAGM-norm VaR (5%),real_gdp_DAGM-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_DAGM-norm VaR (5%)","real_gdp_DAGM-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_DAGM-skew norm VaR (5%)","real_gdp_DAGM-skew norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# real_gdp_DAGM-skew std VaR (5%), real_gdp_DAGM-skew std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","real_gdp_DAGM-skew std VaR (5%)","real_gdp_DAGM-skew std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# bonds GARCH-MIDAS-norm VaR (5%),bonds GARCH-MIDAS-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","bonds_GARCH-MIDAS-norm VaR (5%)","bonds_GARCH-MIDAS-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
legend(
  "topright",
  c("SSMI daily ret.","bonds_GARCH-MIDAS-skew norm VaR (5%)","bonds_GARCH-MIDAS-skew norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# bonds_GARCH-MIDAS-std VaR (5%),bonds_GARCH-MIDAS-std ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","bonds_GARCH-MIDAS-std VaR (5%)","bonds_GARCH-MIDAS-std ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
# bonds_DAGM-norm VaR (5%),bonds_DAGM-norm ES (5%)
...
legend(
  "topright",
  c("SSMI daily ret.","bonds_DAGM-norm VaR (5%)","bonds_DAGM-norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
legend(
  "topright",
  c("SSMI daily ret.","bonds_DAGM-skew norm VaR (5%)","bonds_DAGM-skew norm ES (5%)"),
  lty=1,
  col=c("black","red","gray"),
  lwd=2)
...
plot(1:N,coredata(r_t_est),type="l",
     ...
     xlab="",ylab="SP500: Returns, VaR and ES (5%)",
     cex.lab=2,font.lab=2,lty=1,col="black",lwd=2)
...
legend(
  "topright",
  c("SSMI daily ret.","SAV VaR (5%)","SAV ES (5%)"),
  lty=1,
...
plot(1:N,coredata(r_t_est),type="l",
     ...
     xlab="",ylab="SMI: Returns, VaR and ES (5%)",
     cex.lab=2,font.lab=2,lty=1,col="black",lwd=2)
...
legend(
  "topright",
  c("SMI daily ret.","AS VaR (5%)","ES VaR (5%)"),
  lty=1,
...
plot(1:N,coredata(r_t_est),type="l",
     ...
     xlab="",ylab="SSMI: Returns and VaR (5%)",
     cex.lab=2,font.lab=2,lty=1,col="black",lwd=2)
...
legend(
  "topright",
  c("SSMI daily ret.","Linear ARCH(6) VaR (5%)","Linear ARCH(6) ES (5%)"),
  lty=1,
